...
from utils.thinking_patterns import ThinkingCategory, ThinkingPattern, thinking_registry
...
class TestThinkingPatternRegistry:
    ...
    def test_pattern_selection(self):
        ...
        assert any(name in ["analytical_thinking", "vertical_thinking", "first_principles"] 
    ...
    def test_pattern_selection_architecture(self):
        ...
        assert any(name in ["systems_thinking", "modular_thinking", "holistic_thinking"] 
                  for name in pattern_names)
    ...
    def test_effectiveness_scores(self):
        ...
        for pattern in thinking_registry.get_all_patterns():
            ...
            for problem_type, score in pattern.effectiveness_scores.items():
                assert 0 <= score <= 1
...
class TestEnhancedThinkDeep:
    ...
    def mock_memory(self):
        ...
        with patch('tools.thinkdeep_enhanced.save_memory') as mock_save, \
