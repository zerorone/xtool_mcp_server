...
class MemoryRecallEngine:
    ...
    def context_similarity(self, memory: Dict[str, Any], context: Dict[str, Any]) -> float:
        ...
        """
        score = 0.0
        weights = {"time": 0.2, "tags": 0.3, "type": 0.2, "layer": 0.1, "importance": 0.2}
        ...
        if context.get("layer") and memory.get("layer"):
            ...
            layer_match = layer_scores.get((context["layer"], memory["layer"]), 0.5)
...
def advanced_memory_recall(
    ...
    **kwargs,
    ...
    return engine.advanced_recall(query=query, context=context, thinking_patterns=thinking_patterns, **kwargs)
