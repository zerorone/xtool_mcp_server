"""
Thinking Patterns Registry - 25 Expert Thinking Modes for Zen
...
Key Features:
- 25 distinct thinking patterns covering all major cognitive approaches
...
class ThinkingPatternRegistry:
    ...
    def _initialize_patterns(self):
        """Initialize all 25 thinking patterns"""
        
        # 1. First Principles Thinking
        self.register_pattern(ThinkingPattern(
